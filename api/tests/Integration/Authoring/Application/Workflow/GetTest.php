...
use Dairectiv\Authoring\Application\Workflow\Get\Input;
use Dairectiv\Authoring\Application\Workflow\Get\Output;
...
#[Group('authoring')]
#[Group('use-case')]
final class GetTest extends IntegrationTestCase
{
