...
describe("useArchiveWorkflow", () => {
  ...
  it("should call mutation when archiveWorkflow is called", async () => {
  ...
  it("should call onSuccess callback when provided", async () => {
    ...
    const { result } = renderHook(() => useArchiveWorkflow("workflow-123", { onSuccess }));
  ...
  it("should call onError callback when provided", async () => {
    ...
    const { result } = renderHook(() => useArchiveWorkflow("workflow-123", { onError }));
